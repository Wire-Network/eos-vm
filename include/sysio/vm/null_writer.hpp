...
class null_writer {
 public:
   ...
   branch_t emit_return(uint32_t /*depth_change*/, bool /*is_loop_target*/) { return {}; }
   void emit_block() {}
   label_t emit_loop() { return {}; }
   branch_t emit_if() { return {}; }
   branch_t emit_else(branch_t /*if_loc*/) { return {}; }
   branch_t emit_br(uint32_t /*depth_change*/, bool /*is_loop_target*/) { return {}; }
   branch_t emit_br_if(uint32_t /*depth_change*/, bool /*is_loop_target*/) { return {}; }
   struct br_table_parser {
      branch_t emit_case(uint32_t /*depth_change*/, bool /*is_loop_target*/) { return {}; }
      branch_t emit_default(uint32_t /*depth_change*/, bool /*is_loop_target*/) { return {}; }
   };
