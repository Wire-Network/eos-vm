...
inline int32_t _sysio_f32_trunc_i32s( float af ) {
   float32_t a = to_softfloat32(af);
   EOS_VM_ASSERT(!(_sysio_f32_ge(af, 2147483648.0f) || _sysio_f32_lt(af, -2147483648.0f)), wasm_interpreter_exception, "Error, f32.convert_s/i32 overflow" );
...
inline int32_t _sysio_f64_trunc_i32s( double af ) {
   float64_t a = to_softfloat64(af);
   EOS_VM_ASSERT(!(_sysio_f64_ge(af, 2147483648.0) || _sysio_f64_lt(af, -2147483648.0)), wasm_interpreter_exception, "Error, f64.convert_s/i32 overflow");
...
inline uint32_t _sysio_f32_trunc_i32u( float af ) {
   float32_t a = to_softfloat32(af);
   EOS_VM_ASSERT(!(_sysio_f32_ge(af, 4294967296.0f) || _sysio_f32_le(af, -1.0f)),wasm_interpreter_exception, "Error, f32.convert_u/i32 overflow");
...
inline uint32_t _sysio_f64_trunc_i32u( double af ) {
   float64_t a = to_softfloat64(af);
   EOS_VM_ASSERT(!(_sysio_f64_ge(af, 4294967296.0) || _sysio_f64_le(af, -1.0)), wasm_interpreter_exception, "Error, f64.convert_u/i32 overflow");
...
inline int64_t _sysio_f32_trunc_i64s( float af ) {
   float32_t a = to_softfloat32(af);
      EOS_VM_ASSERT(!(_sysio_f32_ge(af, 9223372036854775808.0f) || _sysio_f32_lt(af, -9223372036854775808.0f)), wasm_interpreter_exception, "Error, f32.convert_s/i64 overflow");
...
inline int64_t _sysio_f64_trunc_i64s( double af ) {
   float64_t a = to_softfloat64(af);
   EOS_VM_ASSERT(!(_sysio_f64_ge(af, 9223372036854775808.0) || _sysio_f64_lt(af, -9223372036854775808.0)), wasm_interpreter_exception, "Error, f64.convert_s/i64 overflow");
...
inline uint64_t _sysio_f32_trunc_i64u( float af ) {
   float32_t a = to_softfloat32(af);
   EOS_VM_ASSERT(!(_sysio_f32_ge(af, 18446744073709551616.0f) || _sysio_f32_le(af, -1.0f)), wasm_interpreter_exception, "Error, f32.convert_u/i64 overflow");
...
inline uint64_t _sysio_f64_trunc_i64u( double af ) {
   float64_t a = to_softfloat64(af);
   EOS_VM_ASSERT(!(_sysio_f64_ge(af, 18446744073709551616.0) || _sysio_f64_le(af, -1.0)), wasm_interpreter_exception, "Error, f64.convert_u/i64 overflow");
