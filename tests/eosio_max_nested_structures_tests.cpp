...
struct static_options_3 {
   static constexpr std::uint32_t sysio_max_nested_structures = 3;
};
struct static_options_4 {
   static constexpr std::uint32_t sysio_max_nested_structures = 4;
};
struct dynamic_options {
   std::uint32_t sysio_max_nested_structures;
};
